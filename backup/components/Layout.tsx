...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-navy border-b border-white/10 py-4 md:py-6 relative">
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`text-3xl font-serif italic ${
                    location.pathname === link.path ? 'text-terracotta' : 'text-white/80'
                  }`}
                >
                  {link.name}
                </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 md:gap-24 mb-20">
          <div className="md:col-span-2 flex flex-col items-center text-center">
            <Link to="/" className="flex flex-col items-center mb-8">
              <img src="/logo.png" alt="Jennie Wolff" className="h-28 md:h-36 w-auto object-contain" />
