       ...
       <header className="section-padding pb-0 pt-40 relative">
         ...
         <div className="max-container">
           ...
           <motion.h1 
             ...
             className="text-4xl md:text-6xl font-serif leading-[1.1] max-w-4xl"
           >
       ...
       <section className="py-32 bg-navy relative overflow-hidden">
         ...
         <div className="max-container px-6 text-center relative z-10">
            <motion.h2
              ...
              transition={{ duration: 1 }}
              viewport={{ once: true }}
              className="text-4xl md:text-6xl font-serif italic leading-tight max-w-5xl mx-auto text-white"
            >
       ...
       <section className="section-padding bg-terracotta">
         <div className="max-container">
           <div className="max-w-3xl mb-16">
             <h2 className="text-4xl font-serif mb-6 text-white">My process is intentionally part-coach, part-consultant, part-ritual-keeper.</h2>
       ...
       <section className="section-padding bg-navy">
         <div className="max-container">
           <motion.h2
             ...
             whileInView={{ opacity: 1, x: 0 }}
             viewport={{ once: true }}
             className="text-3xl md:text-5xl font-serif mb-16 border-b border-white/20 pb-8 text-white"
           >
           ...
           <div className="space-y-16">
             {[
               ...
               >
                 <h4 className="md:col-span-1 text-xs uppercase tracking-[0.2em] text-blush font-bold transition-all group-hover:translate-x-2">
                   {cred.title.split(':')[0]}
                 </h4>
                 <div className="md:col-span-3 space-y-4">
                   <p className="font-serif text-2xl md:text-3xl leading-tight text-white group-hover:text-blush transition-colors">{cred.title}</p>
                   <p className="text-white/60 text-lg leading-relaxed max-w-2xl">{cred.desc}</p>
                 </div>
               </motion.div>
             ))}
           </div>
